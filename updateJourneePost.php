...
if(isset($_GET['modifieJournee'])){
    ...
    $tempsTravaille = (date('H', strtotime($_POST['HFin'])) * 60 + date('i', strtotime($_POST['HFin']))) - (date('H', strtotime($_POST['HDebut'])) * 60 + date('i', strtotime($_POST['HDebut'])));
    ...
    if($tempsTravaille > 0){
        ...
        if($donnees['HFin'] != date('H:i:s', strtotime($_POST['HF'])))
