...
if (!isset($_SESSION['id']))
    ...
    if (isset($_GET['modifie'])) {
        if (!empty($_GET['modifie']) and $_GET['modifie'] == "ajouterJournee") {
            ...
            if (isset($_GET['errorAjout']) or isset($_GET['errorHeure']) or isset($_GET['errorCoupure'])) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="text-align: left">
                            <input style="font-size: 250%; margin-top: 3%" type="date"
                                   name="date" <?= "value='" . $_GET['date'] . "'" ?> required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6" style="text-align: right">
                        ...
                        <div class="col-sm-6" style="text-align: left">
                            <input style="font-size: 250%; margin-top: 3%" type="time"
                                   name="HD" <?= "value='" . $_GET['HD'] . "'" ?> required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6" style="text-align: right">
                        ...
                        <div class="col-sm-6" style="text-align: left">
                            <input style="font-size: 250%; margin-top: 3%" type="time"
                                   name="HF" <?= "value='" . $_GET['HF'] . "'" ?> required>
                        </div>
                    </div>
                    <?php
                    if (!$SantosUser) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" style="text-align: left">
                                <input style="font-size: 250%; margin-top: 3%" type="time"
                                       name="coupure" <?= "value='" . $_GET['coupure'] . "'" ?> required>
                            </div>
                        </div>
                        <?php
                    }
                ...
                <form action="modificationDonneesPost.php?ajout" method="POST" style="margin-top: 10%;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="text-align: left">
                            <input style="font-size: 250%; margin-top: 3%" type="time"
                                   name="HD" <?= "value='" . date("H:i") . "'" ?> required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6" style="text-align: right">
                        ...
                        <div class="col-sm-6" style="text-align: left">
                            <input style="font-size: 250%; margin-top: 3%" type="time"
                                   name="HF" <?= "value='" . date("H:i") . "'" ?> required>
                        </div>
                    </div>
                    <?php
                    if (!$SantosUser) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" style="text-align: left">
                                <input style="font-size: 250%; margin-top: 3%" type="time" name="coupure"
                                       value="01:00:00" required>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="text-align: left">
                            <label style='font-size: 300%; margin-top: 3%' for='oui'>Oui </label> <input
                                    style='width: 34%; height: 34%; margin-left: 2%' name='decouche' type='radio'
                                    id='oui' value='oui'>";
                            <label style='font-size: 300%; margin-top: 3%; margin-left: -16%' for='non'>Non </label>
                            <input style='width: 34%; height: 34%; margin-left: 2%' name='decouche' type='radio'
                                   id='non' value='non' checked>
                        </div>
                    </div>
            ...
            <div style="margin-top: 8%">
                <a class="button" <?= "href='modifieJournee.php?mois=" . date('m') . "&annee=" . date('Y') . "'" ?> >Modifier
                    une journée</a>
            </div>
            <div style="bottom: 14%; left: 0; right: 0; margin-left: auto; margin-right: auto; width: auto;  position: absolute">
    ...
    } elseif ($donnees = $bdd->query("SELECT HDebut FROM Horaire WHERE Datage = '" . date('Y-m-d') . "' AND IdUser = '" . $_SESSION['id'] . "' AND HFin IS NULL")->fetch()) {
        ?>
        <h1 style="font-size: 375%; margin-top: 21%">La journée a commencé à <span
                    style="font-weight: bold"><?= date("H:i", strtotime($donnees['HDebut'])) ?></span></h1>
        <?php
        if ($pause = $bdd->query("SELECT * FROM Pause WHERE IdUser = " . $_SESSION['id'] . " AND HFin IS NULL")->fetch()) {
            ?>
            <h1 style="font-size: 312%; margin-top: 14%; font-style: italic">Vous êtes en pause
                depuis <?= date('H:i', strtotime($pause['HDebut'])) ?></h1>
        ...
        ?>
        <h1 style="font-size: 375%; margin-top: 20%">La journée s'est finie à <span
                    style="font-weight: bold"><?= date("H:i", strtotime($donnees['HFin'])) ?></span></h1>
