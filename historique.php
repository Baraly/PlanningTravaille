...
<body>
    ...
    <h1 style="font-size: 20px; width: 100%; text-align: center; margin-bottom: 0; padding-bottom: 0">Historique des données</h1>
            ...
            ?>
                                <div class="swiper mySwiper">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="content">
                                                <h2 style="width: 100%; text-align: left; margin-bottom: 5%">Année <?= date('Y') ?></h2>
                                                <div class="mois">
                                                    <?php
    ...
    <div style="position: fixed; bottom: 6%; width: 100%; text-align: center">
        <a style="font-size: 20px; border: 1px solid gray; border-radius: 10px; background-color: #464646; color: white; padding: 2% 2%; text-decoration: none" href="planning.php">Retourner à la liste</a>
    </div>
